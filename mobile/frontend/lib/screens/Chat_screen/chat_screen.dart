                ...
                if (isOnline)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 12,
                      decoration: BoxDecoration(
                        color: Colors.grey, // gray online dot
...
class _UserSearchDialogState extends State<UserSearchDialog> {
  ...
  // Define theme colors
  final Color primaryGreen = Colors.grey.shade800; // gray
  final Color lightGreen = Colors.grey.shade100;   // gray
  final Color mediumGreen = Colors.grey.shade300;  // gray
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.search, color: primaryGreen), // gray
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(16),
                    borderSide: BorderSide(color: primaryGreen, width: 2), // gray
                  ),
                  filled: true,
                  ...
                  if (!snapshot.hasData) {
                    return Center(
                      child: CircularProgressIndicator(
                        valueColor: AlwaysStoppedAnimation<Color>(primaryGreen), // gray
                      ),
                    );
                  }
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color: index.isEven ? lightGreen : Colors.white, // gray
                              borderRadius: BorderRadius.circular(12),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    CircleAvatar(
                                      radius: 32,
                                      backgroundColor: mediumGreen, // gray
                                      ...
                                      child: userData['photoURL'] == null || 
                                          ...
                                          ? Icon(Icons.person, color: primaryGreen, size: 36) // gray
                                          : null,
                                    ),
                                    SizedBox(width: 16),
