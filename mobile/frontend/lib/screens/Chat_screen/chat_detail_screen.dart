          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                Color.fromARGB(65, 120, 120, 120), // gray
                Color.fromARGB(120, 120, 120, 120), // gray
                Color.fromARGB(255, 80, 80, 80),    // gray
              ],
              ...
              children: [
                IconButton(
                  icon: _isUploadingFile
                      ...
                      : Icon(Icons.attach_file, color: Colors.grey.withOpacity(0.6)),
